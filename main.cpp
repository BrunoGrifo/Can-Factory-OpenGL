...
GLfloat  cinzento[] = { 0.5 ,0.5 ,0.5 }, preto[] = { 0 ,0 ,0 }, azul[] = { 0.0, 0.0, 1.0 }, vermelho[] = { 1, 0, 0 }, branco[] = {1,1,1}, verde[] = { 0,1,0 };
...
//por no final a funçao do bule a ver se funciona
...
void draw_cylinder(int state_flag, int textura_index) {  //Fui buscar à net
	...
	if (state_flag == 1) {
		gluCylinder(quadratic, 0.2f, 0.2f, 0.8, 50, 50);
...
void criaDefineTexturas(void) {
	//----------------------------------------- Chao z=0
	defineTextura(0, "chao.bmp");
	defineTextura(1, "brilho.bmp");
	defineTextura(2, "lt.bmp");
	defineTextura(3, "rt.bmp");
	defineTextura(4, "ft.bmp");
	defineTextura(5, "bk.bmp");
	defineTextura(6, "up.bmp");
	defineTextura(7, "top1.bmp");
	defineTextura(8, "coca1.bmp");
	defineTextura(9, "topcan3.bmp");
	defineTextura(10, "metal3.bmp");
	defineTextura(11, "tijolo.bmp");
	defineTextura(12, "canfloor.bmp");
	defineTextura(13, "capa.bmp");
	defineTextura(14, "par3.bmp");
	defineTextura(15, "chaosujo.bmp");
	defineTextura(16, "detail1.bmp");
	defineTextura(17, "prateleira.bmp");
	defineTextura(18, "metaltable.bmp");
	defineTextura(19, "wood.bmp");
	defineTextura(20, "calendar.bmp");
	defineTextura(21, "candeiro.bmp");
	defineTextura(22, "ini.bmp");
	defineTextura(23, "paper2.bmp");
	defineTextura(24, "paper3.bmp");
	defineTextura(25, "paper4.bmp");
	defineTextura(26, "coca2.bmp");
	defineTextura(27, "coca3.bmp");
	defineTextura(28, "coca4.bmp");
	defineTextura(29, "wallstain.bmp");
	defineTextura(30, "1.bmp");
	defineTextura(31, "2.bmp");
	defineTextura(32, "3.bmp");
	defineTextura(33, "4.bmp");
	defineTextura(34, "5.bmp");
	defineTextura(35, "6.bmp");
...
void drawLamps() {
	...
	glTranslatef(0, 0, 0.1);
	glutSolidSphere(0.25, 50, 50);
	glPopMatrix();//15 4 1 12 4 1 13.5 4 1
	glPushMatrix();
	glEnable(GL_TEXTURE_2D);
	glBindTexture(GL_TEXTURE_2D, textures[21]);
	glMaterialfv(GL_FRONT, GL_AMBIENT, preto);
...
void drawScene(void) {
	...
	glPushMatrix();
	/*if (ligaLuz || ligaLuz1 || ligaLuz2) {
		glMaterialfv(GL_FRONT, GL_AMBIENT, contraste2);
	}
	else {*/
		glMaterialfv(GL_FRONT, GL_AMBIENT, cinzento);
	//}
...
void display(void) {
	...
	//minimapa
	/*glViewport(0, hScreen/2, wScreen / 4, hScreen / 4);
	printf("%.02f \n", hScreen/2);
	glMatrixMode(GL_PROJECTION);
	glLoadIdentity();
	glOrtho(-xC,xC, -xC, 25, -80, 80);
	...
	//glViewport(wScreen / 2, hScreen / 2, 0.75*wScreen, 0.75*hScreen);
	glMatrixMode(GL_PROJECTION);
	glLoadIdentity();
